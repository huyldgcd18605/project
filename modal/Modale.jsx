...
const ModalWrap = ({name, show, setShow}) => {
    const Closemode = ()=>{
        setShow(false)
    }
    return (
          ...
          <View style={styles.modelForm}>
              <View style={styles.Boxder}>
                ...
                <View style={{alignItems:'center'}}>
                    <Icon style={styles.iconerror} name={'alert-circle'} size={90} color="#CF000F" />
                </View>
                <View style={{alignItems:'center'}}>
                    <Text style={styles.content}>Should fill out all the fields.</Text>
                </View>
                <View style={{alignItems:'center'}}>
